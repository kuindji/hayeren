...
**Files:**
- Create: `src/shared/hooks/useSwallowEventCallback.ts`, `src/shared/hooks/useUpdateEffect.ts`, `src/shared/Text.tsx`, `src/shared/icons.tsx`, `src/site/contexts.ts`, `src/site/hooks.ts`, `src/site/App.tsx`, `src/site/components/Header.tsx`, `src/site/components/Footer.tsx`, `src/site/components/ChaptersMenu.tsx`, `src/site/pages/Alphabet.tsx`, `src/model/alphabet.ts`, `src/styles/index.scss` + ported partials, `tests/site/text.test.tsx`, `tests/site/app.test.tsx`
...
function useRequired<T>(ctx: RC<T | null>): T {
